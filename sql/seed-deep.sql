...
VALUES
  ((SELECT id FROM employees WHERE employee_code = 'D-EMP-001'), '2026-05-01', 2500.00, 4000.00, 1500.00, 1800.00, 'Seeded May 2026 adjustment.'),
  ((SELECT id FROM employees WHERE employee_code = 'D-EMP-002'), '2026-05-01', 1200.00, 2500.00, 0.00, 1100.00, 'Seeded May 2026 adjustment.'),
  ((SELECT id FROM employees WHERE employee_code = 'D-EMP-003'), '2026-05-01', 900.00, 0.00, 1000.00, 950.00, 'Seeded May 2026 adjustment.'),
  ((SELECT id FROM employees WHERE employee_code = 'D-EMP-004'), '2026-05-01', 1800.00, 2200.00, 3000.00, 1250.00, 'Seeded May 2026 adjustment.')
